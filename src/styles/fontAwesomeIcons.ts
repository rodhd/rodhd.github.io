...
import { faArrowLeft, faCircle, faEye, faFilePdf, faGlobe, faVideo, faDesktop, faTable, faCode, faListAlt, faCloud, faBuilding, faCalendar, faMapMarker, faExternalLinkAlt } from '@fortawesome/free-solid-svg-icons';
